    ...
    >
      <div className="max-w-2xl mx-auto text-center">
        ...
        <WordReveal
          ...
          style={{ fontSize: 'clamp(2rem, 6vw, 3.5rem)', lineHeight: '1.05' } as CSSProperties}
          delay={60}
          stagger={60}
        >
        ...
        {state?.success ? (
          <div className="inline-flex items-center justify-center gap-2 px-8 py-3 rounded-full bg-accent/15 text-accent font-semibold text-sm mb-10 animate-[fade-up-sm_400ms_cubic-bezier(0.23,1,0.32,1)_both]">
        ...
        <p className="text-muted text-xs mt-12">{bio.name} · {bio.location}</p>
      </div>
    </section>
  )
}
